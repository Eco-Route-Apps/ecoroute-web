      ...
      <MediaQuery minWidth={992}>
        ...
        <div className="faqsCont">
          <Row tag="div" className="faqrow">
            <Col sm="3">
              <Card body className="faqCard" tag="div">
                <CardImg
                  ...
                  width="100%"
                />
                <CardTitle tag="h5">Penggunaan Aplikasi</CardTitle>
                <CardSubtitle className="faqsubtitle mb-2 text-muted" tag="h6">
                  Bantuan seputar fitur, konektivitas dan penggunaan aplikasi
                  secara umum
                </CardSubtitle>
              </Card>
            ...
            <Col sm="3">
              <Card body className="faqCard" tag="div">
                <CardImg
                  ...
                  width="100%"
                />
                <CardTitle tag="h5">Akun dan Privasi</CardTitle>
                <CardSubtitle className="faqsubtitle mb-2 text-muted" tag="h6">
            ...
            <Col sm="3">
              <Card body className="faqCard" tag="div">
                <CardImg alt="Komunitas" src={komunitas} top width="100%" />
                <CardTitle tag="h5">Komunitas</CardTitle>
                <CardSubtitle className="faqsubtitle mb-2 text-muted" tag="h6">
                  Bantuan seputar dukungan komunitas, kolaborasi, dan pengadaan
                  event.
                </CardSubtitle>
              </Card>
              <CardFooter className="faqcardfooter" tag="div">
            ...
            <Col sm="3">
              <Card body className="faqCard" tag="div">
                <CardImg alt="Lainnya..." src={langganan} top width="100%" />
                <CardTitle tag="h5">Lainnya...</CardTitle>
                <CardSubtitle className="faqsubtitle mb-2 text-muted" tag="h6">
